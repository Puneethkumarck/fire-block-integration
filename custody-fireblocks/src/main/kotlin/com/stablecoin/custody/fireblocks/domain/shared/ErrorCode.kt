...
enum class ErrorCode(
    ...
    ALLOCATION_NOT_FOUND("CUSTODY-2003", 404),
    ALLOCATION_ALREADY_RELEASED("CUSTODY-2004", 409),
    TRANSACTION_NOT_CANCELLABLE("CUSTODY-2010", 409),
    TRANSACTION_ALREADY_TERMINAL("CUSTODY-2011", 409),
    FIREBLOCKS_API_ERROR("CUSTODY-3001", 502),
    FIREBLOCKS_TIMEOUT("CUSTODY-3002", 504),
    WEBHOOK_VERIFICATION_FAILED("CUSTODY-4001", 401),
    RATE_LIMIT_EXCEEDED("CUSTODY-4002", 429),
    INTERNAL_ERROR("CUSTODY-5001", 500),
    CONCURRENT_MODIFICATION("CUSTODY-5002", 409),
    OUTBOX_PUBLISH_FAILED("CUSTODY-5003", 500),
    RECONCILIATION_FAILED("CUSTODY-6001", 500),
}
